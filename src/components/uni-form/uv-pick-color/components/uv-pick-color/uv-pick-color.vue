    ...
    <view class="uv-pick-color">
      ...
      >
        ...
        >
          ...
          <view class="uv-pick-color__box__bg-pointer" :style="[pointerStyle]">
          </view>
        </view>
      </view>
...
<script>
import uvPopup from '../../../uv-popup/components/uv-popup/uv-popup.vue';
import uvToolbar from '../../../uv-toolbar/components/uv-toolbar/uv-toolbar.vue';
